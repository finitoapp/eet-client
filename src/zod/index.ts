/**
 * Optional zod v4 schemas for `@finitoapp/eet-client`, imported from `@finitoapp/eet-client/zod`.
 * `zod` is a peer dependency, not a regular dependency — install it yourself
 * (`bun add zod@^4`) to use this entry point. The main `@finitoapp/eet-client` entry point never
